          ...
          return (
            <div key={m.id} className={cfg.cardClass} style={{ position: "relative", overflow: "hidden" }}>
              ...
              <div
                ...
                style={{ background: `linear-gradient(90deg, ${cfg.accent}, ${cfg.accent}44)` }}
              />
              ...
              {session && (
                ...
                >
                  <p className="text-xs mb-0.5" style={{ color: "#9CA3AF", fontFamily: "'Chakra Petch', sans-serif" }}>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ background: "rgba(0,0,0,0.7)", backdropFilter: "blur(4px)" }}>
          ...
          >
            ...
            <div className="flex items-center justify-between mb-5">
              <h2 className="text-base text-white font-display">
                {editMachine ? "Modifier le poste" : "Ajouter un poste"}
              </h2>
              <button
                onClick={() => { setShowForm(false); setEditMachine(null); }}
            ...
            <form onSubmit={soumettre} className="space-y-4">
              ...
              <div>
                ...
                <select className="input" value={form.type} onChange={(e) => setForm({ ...form, type: e.target.value })}>
                  {["PS5", "PC", "VR", "XBOX", "SWITCH", "AUTRE"].map((t) => (
              ...
              <div className="pt-1" style={{ borderTop: "1px solid rgba(124,58,237,0.12)" }}>
                <div className="flex items-center gap-2 mb-3 mt-1">
                  ...
                  <p className="text-xs" style={{ color: "#A78BFA", fontFamily: "'Chakra Petch', sans-serif" }}>
                    Smart TV associée (optionnel)
                  </p>
                </div>
                <div className="space-y-3">
                  <div>
                    ...
                    <input
                      ...
                      value={form.tvMac}
                      onChange={(e) => setForm({ ...form, tvMac: e.target.value })}
